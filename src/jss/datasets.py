...
Public API
----------
``load(name, mode, *, data_path=None) -> eval_df``
...
def _finalize(raw: pd.DataFrame, family: str, mode: str) -> pd.DataFrame:
    """standardise -> validate. Shared tail for every loader."""
...
def load(
    ...
    *,
    ...
    """Load a dataset as a canonical eval DataFrame.
    ...
    eval_df : pandas.DataFrame
        Canonical (standardise + validate) frame ready for the experiment matrix.
    """
    ...
    return _finalize(raw, family, mode)
